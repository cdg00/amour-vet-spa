...
export const PRODUCTS: ProductData[] = [
  ...
  },
  {
    ...
    active: true,
    variants: [
      { id: "22222222-0000-4000-8000-00000000000b", color: "Lila", colorHex: "#C4A7D7", stock: 10, active: true },
      { id: "22222222-0000-4000-8000-00000000000c", color: "Blanca", colorHex: "#FFFFFF", stock: 10, active: true },
      { id: "22222222-0000-4000-8000-00000000000d", color: "Gris", colorHex: "#9CA3AF", stock: 10, active: true },
      { id: "22222222-0000-4000-8000-00000000000e", color: "Rosa", colorHex: "#F4A7C3", stock: 10, active: true },
    ],
  },
  {
