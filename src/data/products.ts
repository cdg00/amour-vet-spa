...
export const PRODUCTS: ProductData[] = [
  ...
  },
  {
    ...
    active: true,
    variants: [
      { id: "6e225fc7-a81a-4f16-9004-ec7ae061ca42", color: "Rojo", colorHex: null, stock: 2, active: true },
    ],
  },
  {
    ...
    active: true,
    variants: [
      { id: "c331f6c5-2e91-42c2-8dbd-6e9ec704486a", color: "Beige", colorHex: null, stock: 1, active: true },
      { id: "dbf076fd-0a9b-4794-a32f-31a93864c6de", color: "Blanco", colorHex: null, stock: 1, active: true },
      { id: "a99b8ff9-93f8-4c2e-a8e0-0f3487d1631b", color: "Chocolate", colorHex: null, stock: 1, active: true },
      { id: "2cff760c-6ef8-4688-85eb-94be0ff96431", color: "Natural", colorHex: null, stock: 1, active: true },
      { id: "3bf6c747-71fa-4711-b848-e24ad345a0fc", color: "Negro", colorHex: null, stock: 1, active: true },
    ],
  },
  {
  ...
  },
  {
    ...
    active: true,
    variants: [
      { id: "b0c39333-5cc0-42b3-b9a9-ca79eaebaacf", color: "Blanco", colorHex: null, stock: 2, active: true },
      { id: "c200cc93-f3cc-44c9-945f-aa403dee94ca", color: "Gris", colorHex: null, stock: 2, active: true },
      { id: "9ce74695-7adc-4081-a01b-3ffdfefb3053", color: "Negro", colorHex: null, stock: 2, active: true },
      { id: "5113cd3c-5c6e-4a79-ba8e-17e9ca374cf7", color: "Rojo", colorHex: null, stock: 2, active: true },
    ],
  },
  {
    ...
    active: true,
    variants: [
      { id: "1643f4d2-c401-477d-a669-e0cf41505eff", color: "Blanco", colorHex: null, stock: 2, active: true },
    ],
  },
  {
    ...
    active: true,
    variants: [
      { id: "fc83cdc9-b928-49b1-8129-c199c24c65cf", color: "Blanco", colorHex: null, stock: 2, active: true },
      { id: "992c0da4-4855-4b34-a718-daef902b94c5", color: "Gris", colorHex: null, stock: 2, active: true },
      { id: "4f1d3147-127c-470b-a75f-129c6cf65993", color: "Negro", colorHex: null, stock: 2, active: true },
    ],
  },
  {
    ...
    active: true,
    variants: [
      { id: "e8e41db4-223e-4c55-af27-2bd0963fdb1a", color: "Blanco", colorHex: null, stock: 2, active: true },
      { id: "fc0a0885-4e07-47db-80f8-ad566700ca32", color: "Cebra", colorHex: null, stock: 2, active: true },
      { id: "74f6fb18-4c63-46f0-9c4e-d58a7a9714a4", color: "Celeste", colorHex: null, stock: 2, active: true },
      { id: "46f99f16-d65c-4b4f-9cb9-3ff6d5e85d58", color: "Rosa", colorHex: null, stock: 2, active: true },
    ],
  },
  {
  ...
  },
  {
    ...
    active: true,
    variants: [
      { id: "75a9ed5a-4e6a-4e55-9a00-ac87509b29d3", color: "Blanco", colorHex: null, stock: 2, active: true },
      { id: "759523af-cc89-47a0-84f2-e4e4710a7ca6", color: "Rojo", colorHex: null, stock: 2, active: true },
    ],
  },
  {
    ...
    active: true,
    variants: [
      { id: "d90d73b3-5aa9-40c0-b83d-63e1d46c94b8", color: "Blanco", colorHex: null, stock: 2, active: true },
      { id: "b748d22c-5b0e-4dbc-80e1-25b3525f5df4", color: "Natural", colorHex: null, stock: 2, active: true },
    ],
  },
  {
  ...
  },
  {
    ...
    active: true,
    variants: [
      { id: "22222222-0000-4000-8000-00000000000c", color: "Blanca", colorHex: "#FFFFFF", stock: 3, active: true },
      { id: "615a434c-0f55-4471-bc53-11201fce1635", color: "Gris", colorHex: null, stock: 2, active: true },
      { id: "22222222-0000-4000-8000-00000000000b", color: "Lila", colorHex: "#C4A7D7", stock: 1, active: true },
      { id: "14d055e0-eddb-4c38-a9fe-b2cf0641ba2e", color: "Rosa", colorHex: null, stock: 1, active: true },
    ],
  },
  {
